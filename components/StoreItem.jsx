    ...
    <>
      ...
      >
        ...
        <div className='flex w-full h-full items-center justify-center mt-3 z-10'>
          <img src={'https://media.valorant-api.com/weaponskinchromas/2bd28382-48c6-8579-83e8-e9b64b783de3/displayicon.png'} className={'w-4/5 drop-shadow-2xl transition-opacity duration-100 ease-in'} />
        </div>
        <div 
          id='item-price'
        ...
        >
          ...
          <img src="/img/vp_icon.png" className='w-7 ml-2' />
        </div>
      </div>
    </>
  )
